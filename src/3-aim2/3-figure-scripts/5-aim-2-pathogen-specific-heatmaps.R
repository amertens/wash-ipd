...
adj_RR$pval_cat <- ifelse(adj_RR$sign == -1, paste0(adj_RR$pval_cat, " increase risk"), 
                     paste0(adj_RR$pval_cat, " decrease risk"))
adj_RR$pval_cat[adj_RR$pval_cat %in% c("0.2-1 decrease risk", "0.2-1 increase risk")] <- "0.2-1"
table(adj_RR$pval_cat)
adj_RR$pval_cat <- factor(adj_RR$pval_cat, levels = c("<0.01 decrease risk", 
...
adj_RR$est = ""
adj_RR$est = paste0(round(adj_RR$point.diff, 2), " (", round(adj_RR$ci.lb, 2), ", ", round(adj_RR$ci.ub, 2), ")")
