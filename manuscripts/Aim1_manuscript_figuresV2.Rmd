...
```{r, echo=F, warning=F, message=F, fig.width = 6.5, fig.height = 10}
...
```{r, echo=F, warning=F, message=F, fig.width = 6.5, fig.height = 7}

p_unadj_1

```

__Figure S6.__ Forest plots of unadjusted intervention effects on the prevalence of any enteropathogen or type of enteropathogen (any bacteria, any virus, any protozoa and any STH) in different types of environmental samples. Point estimates and confidence intervals are printed next to pooled estimates.
...
__Figure S7.__ Forest plots of unadjusted intervention effects on the prevalence of any MST marker or type of MST marker (human or animal MST markers) in different types of environmental samples. Point estimates and confidence intervals are printed next to pooled estimates.
