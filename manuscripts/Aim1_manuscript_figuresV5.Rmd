...
```{r, echo=F, warning=F, message=F, fig.width = 7, fig.height = 7, fig.align = 'left'}
p_adj_1
```
...
```{r, echo=F, warning=F, message=F, fig.width = 7, fig.height = 9}
p_adj_s2
```
...
__Figure S3.__ Distributions of abundance outcomes. The X-axes are displayed on the log-10 scale. Black vertical lines mark the means, and dashed lines mark the medians.
...
```{r, echo=F, warning=F, message=F, fig.width = 7, fig.height = 7}
p_unadj_1
```
