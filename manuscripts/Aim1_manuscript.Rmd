...
Interventions mostly decreased prevalences by a non-significant ammount, with X% (n/N) estimated protective effects of interventions and X% (n/N) insignificant estimates. `r cmt("XXXX", "Fill in these numbers", "Andrew", "Date")` 


Overall, there was a decreased risk of any pathogen across any sample, with an adjusted RR of `r clean_est(pooled_adj_RR %>% filter(target=="Any pathogen"))`, when pooled across all studies using random effects models (Figure 1). Interventions decreased the risk of any pathogen presence across all specific studies except for Boehm 2016, but the decrease was only significant in Fuhrmeister 2020 `r clean_est(adj_RR %>% filter(target=="Any pathogen", sample=="any sample type", study=="Fuhrmeister 2020"))`.

-discuss specific pathogen samples

-discuss overall MST
-note no overall in Boehm 2016 because of too much positivity in (X)
-discuss specific MST samples



1 any sample type Any pathogen 0.800 0.450 1.42  Odagiri 2016    
2 any sample type Any pathogen 1.21  0.579 2.51  Boehm 2016      
3 any sample type Any pathogen 0.845 0.668 1.07  Reese 2017      
4 any sample type Any pathogen 0.892 0.710 1.12  Steinbaum 2019  
5 any sample type Any pathogen 0.919 0.859 0.984 Fuhrmeister 2020
6 any sample type Any pathogen 0.909 0.751 1.10  Holcomb 2020    
7 any sample type Any pathogen 0.984 0.911 1.06  Kwong 2021    

interventions  (are any individual significant?)


- no significant increase in risk in any estimate


   sample          target                RR  ci.lb ci.ub study           
   <chr>           <chr>              <dbl>  <dbl> <dbl> <fct>           
 1 W               Animal (BacR)      0.604 0.414  0.880 Boehm 2016      
 2 W               Any animal MST     0.673 0.485  0.934 Boehm 2016      
 4 any sample type Any pathogen       0.919 0.859  0.984 Fuhrmeister 2020
 5 any sample type Pathogenic E. coli 0.922 0.858  0.990 Fuhrmeister 2020
 6 any sample type Adenovirus         0.200 0.0638 0.627 Holcomb 2020    
 7 any sample type Shigella           0.318 0.109  0.928 Holcomb 2020    
 8 S               Adenovirus         0.209 0.0643 0.681 Holcomb 2020    
 9 S               Ascaris            0.599 0.409  0.878 Holcomb 2020    
10 S               Shigella           0.279 0.0994 0.784 Holcomb 2020    
11 any sample type Any bacteria       0.911 0.853  0.973 Pooled          
...
__Supplementary Figure 5.__ Forest plots of unadjusted intervention effects on  any general, human and animal MST markers in different types of environmental samples.
