...
6.  The CHoBI7 Trial in Bangladesh (Add citation)
  ...
  Data was shared by the primary investigators of the first 5 studies, but the authors of the  CHoBI7 Trial declined to share the  `r data.", "Note village level WQ data in Odisha. And note substudies within the WASH Benefits Bangladesh trial", "Andrew", "Date")`  
  

  There were `r ` total samples shared across the 5 trials. Table 1. 
